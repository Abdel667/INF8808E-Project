        ...
        [
            html.Div(
                [
                    ...
                    html.Ul(
                        [
                            html.Li(
                                "Which genres or subgenres have experienced the highest growth in popularity over the past 20 years?"
                            ),
                            html.Li("Which genres are declining in popularity?"),
                            html.Li(
                                "Do certain subgenres consistently outperform others across multiple years?"
                            ),
                            html.Li(
                                "When different genres grow in popularity, can we link it to specific audio variables?"
                            ),
                        ]
                    ),
                ],
            ...
            html.Div(
                [
                    ...
                    html.P(
                        "Track how the average popularity of major music genres has evolved over the past two decades."
                    ),
                    dcc.Graph(
            ...
            html.Div(
                [
                    ...
                    html.P(
                        "Compare early period (2000-2002) vs recent period (2018-2020) to identify growth trends."
                    ),
                    dcc.Graph(
            ...
            html.Div(
                [
                    ...
                    html.P(
                        "Heatmap showing how the top 15 subgenres performed across different time periods."
                    ),
                    dcc.Graph(
                        id="subgenre-heatmap",
            ...
            html.Div(
                [
                    ...
                    html.P(
                        "Compare audio characteristics between genres to understand what drives popularity."
                    ),
                    html.Div(
                        [
